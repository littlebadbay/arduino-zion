...
#ifndef LCD1202_Basic_h
#define LCD1202_Basic_h
...
{
	public:
		LCD1202(int SCK, int MOSI, int LED, int RST, int CS);
		void InitLCD();
		void clrScr();
		void clrRow(int row, int start_x = 0, int end_x = 95);
	...
	protected:
		volatile uint8_t *P_SCK, *P_MOSI, *P_LED, *P_RST, *P_CS;
		volatile uint8_t B_SCK, B_MOSI, B_LED, B_RST, B_CS;
		_current_font	cfont;
